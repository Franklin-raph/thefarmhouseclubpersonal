  ...
  return (
    <div>
        <nav className="flex items-center justify-between px-[16px] py-5">
            ...
            <div>
                <button className='border border-teal-500 py-1 px-2 rounded' onClick={()=> setWalletModal(!walletModal)}>Connect Wallet</button>
        ...
        {userModal && 
            <div className="userModal bg-slate-200 fixed right-4 rounded-md p-2 z-10">
                ...
                <div className='flex items-center gap-2 my-3 cursor-pointer'>
                    ...
                    <p className='text-sm'>{user&& `${user.public_key.slice(0, 9)}...${user.public_key.slice(-9)}`}</p>
                    {
        ...
        {walletModal && 
            <div className="walletModal bg-slate-200 fixed right-16 rounded-md p-4 w-[15%]">
                <div className='flex item-center gap-2 mb-3 cursor-pointer'>
