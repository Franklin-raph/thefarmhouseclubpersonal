                    ...
                    <div key={index} className="marketCard w-full cursor-pointer mt-6" onClick={()=> navigate(`/marketinfo/${project.id}`)}>
                        <div className="body">
                          ...
                          <div className='footer flex items-center justify-between mt-9 px-4 pb-4 gap-3'>
                            <div className='py-1 px-2 w-full rounded-[5px]'>
                              <p className='text-gray-500 font-[600]'>TVS</p>
                              <h2 className='font-bold text-xl'>{(project.tvl).toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",")}</h2>
                            </div>
                            <div className='py-1 px-2 w-full p-2 rounded-[5px]'>
                              <p className='text-gray-500 font-[600]'>APY</p>
                              <h2 className='font-bold text-xl'>{project.apy}</h2>
                            </div>
                          </div>
                          <div className='footer flex items-center justify-between px-4 pb-4 gap-3'>
                            <div className='py-1 px-2 w-full p-2 rounded-[5px]'>
                              <p className='text-gray-500 font-[600]'>Total Profit</p>
                              <h2 className='font-bold text-xl'>{project.profit_yield}</h2>
                            </div>
                            <div className='py-1 px-2 w-full p-2 rounded-[5px]'>
                              <p className='text-gray-500 font-[600]'>My Profit</p>
                              <h2 className='font-bold text-xl'>{project.apy}</h2>
                            </div>
                          </div>
                        </div>
